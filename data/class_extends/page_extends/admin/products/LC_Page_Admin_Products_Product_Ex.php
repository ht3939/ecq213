...
class LC_Page_Admin_Products_Product_Ex extends LC_Page_Admin_Products_Product
{
    ...
    public function lfInitFormParam(&$objFormParam, $arrPost)
    {
        ...
        $objFormParam->addParam('月額２年目', 'y2_price', PRICE_LEN, 'n', array('NUM_CHECK', 'MAX_LENGTH_CHECK', 'ZERO_START'));
...
*/
    ...
    public function lfRegistProduct(&$objUpFile, &$objDownFile, $arrList)
    {
        ...
        $sqlval['data_speed_down'] = $arrList['data_speed_down'];
        $sqlval['data_speed_up'] = $arrList['data_speed_up'];
        $sqlval['init_price'] = $arrList['init_price'];
        $sqlval['y1_price'] = $arrList['y1_price'];
        $sqlval['y2_price'] = $arrList['y2_price'];
        $sqlval['cp_price'] = $arrList['cp_price'];
