        ...
        <h2><span class="title"><img src="<!--{$TPL_URLPATH}-->img/title/tit_bloc_search.gif" alt="検索条件" /></span></h2>
            <div class="block_body">
                ...
                <form name="search_form" id="search_form" method="get" action="<!--{$smarty.const.ROOT_URLPATH}-->products/list.php">
                    ...
                    <dl class="formlist">
                        <dt>商品カテゴリから選ぶ</dt>
                        <dd><input type="hidden" name="mode" value="" />
                    ...
                    <dl class="formlist">
                        ...
                        <dt>メーカーから選ぶ</dt>
                        <dd>
                            <!--{html_checkboxes name=maker_id options=$arrMakerList selected=$maker_id }-->
                        </dd>
                    </dl>
                    <dl class="formlist">
                        <!--{/if}-->
                        ...
                        <dt>商品コードを入力</dt>
                        <dd><input type="text" name="product_code" class="box140" maxlength="50" value="<!--{$smarty.get.product_code|h}-->" /></dd>
                    </dl>
                    <p class="btn">
