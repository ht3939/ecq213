	...
	<div id="sidebar">
		<section>
			<div class="overall">
				...
				<p class="overall-img"><img src="<?php echo SITE_ROOT_DIR; ?>img/item/303hw.png" alt="Pocket Wi-Fi 303HW"></p>
				<h3 class="item_name"><span>Huawei</span>Pocket Wi-Fi 303HW</h3>
				<div class="item_status">
					...
					<dl>
						...
						<dd class="rank4"><span>59,676</span>円</dd>
					</dl>
					<dl>
						<dt>月間データ量</dt>
				...
				<p class="side_btn"><a href="http://wifi.yahoo.co.jp/campaign/plan" target="_blank">商品を見る</a></p>
			</div>
		</section>
		...
		<section>
			...
			<div class="rank-about">
				<p class="side-caption">アイコンについて</p>
				 <p><img class="icon-link" src="img/index/icon-link.gif" alt="外部サイト">・・・外部リンク</p>
			</div>
