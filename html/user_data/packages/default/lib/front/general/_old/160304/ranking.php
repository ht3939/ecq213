...
<tr class="js-ranking-item">
	<td class="rank-name">
		...
		<div class="status">
			<p class="name"><span>Huawei</span>Pocket Wi-Fi<br>GL10P</p>
	...
	<td class="rank-data"><span><span class="num"><?php echo $i; ?></span><span class="gb">GB</span></span>/月</td>
	<td class="rank-conditions">プレミアム会員必須<br>3日で3GB制限あり</td>
	<td class="rank-company">
		<a href="#">Yahoo! Wi-Fi</a>
		<p class="site_btn"><a href="#" target="_blank">商品を見る</a></p>
		<p class="note">(Yahoo! Wi-Fi)<!-- (外部サイトへ) --></p>
	</td>
</tr>
